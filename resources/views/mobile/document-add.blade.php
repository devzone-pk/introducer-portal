        ...
        <div class="right">
            <a href="#" data-bs-toggle="modal" data-bs-target="#optionwindow" class="headerButton  toggle-searchbox">
                <svg width="38" height="38" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M9.5 12C9.5 10.6193 10.6193 9.5 12 9.5C13.3807 9.5 14.5 10.6193 14.5 12C14.5 13.3807 13.3807 14.5 12 14.5C10.6193 14.5 9.5 13.3807 9.5 12Z" stroke="#85a555" stroke-width="1.5"/>
                </svg>
            </a>
        </div>
    </div>
