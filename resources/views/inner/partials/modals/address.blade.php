...
<div class="modal fade modalbox" wire:ignore.self id="address-modal" tabindex="-1" role="dialog">
        ...
        <div class="modal-content pt-0  bg-capsule">
            ...
            <div class="modal-body p-0 bg-capsule">
                <div class="bg-dark-blue  justify-content-between d-flex  align-items-center p-2">
                    <h3 class="text-white modal-title">{{ $ad_title }}</h3>
                ...
                <div class="p-1">
                    <div class="form-group  searchbox not-empty">
                        <input type="text" wire:model.debounce.500ms="ad_search_query" class="form-control"
                               placeholder="Search...">
                        <i class="input-icon">
                ...
                @if(!empty($ad_data))
                    <ul class="listview image-listview inset">
                        @foreach($ad_data as $rc)
                            <li>
                                <a href="#" class="item"  data-bs-dismiss="modal" wire:click.prevent="adSelection('{{ $rc['description'] }}')">
