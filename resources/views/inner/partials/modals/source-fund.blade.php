<div class="modal fade modalbox" wire:ignore.self id="source_fund" tabindex="-1" role="dialog">
        ...
        <div class="modal-content  pt-0 bg-capsule">
            ...
            <div class="modal-body p-0">
                <div class="bg-dark-blue  justify-content-between d-flex  align-items-center p-2">
                    <h3 class="text-white modal-title">{{ $sof_title }}</h3>
                ...
                @if(!empty($sof_data))
                    <ul class="listview image-listview inset">
                        @foreach($sof_data as $rc)
                            <li>
                                <a href="#" class="item" data-bs-dismiss="modal"
                                   wire:click.prevent="sofSelection('{{ ($rc) }}')">
