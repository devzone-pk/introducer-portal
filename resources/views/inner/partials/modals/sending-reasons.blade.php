<div class="modal fade modalbox" wire:ignore.self id="sending-reasons-modal" tabindex="-1" role="dialog">
        ...
        <div class="modal-content pt-0  bg-capsule">
            ...
            <div class="modal-body p-0">
                <div class="bg-dark-blue  d-flex  justify-content-between align-items-center p-2">
                    <h3 class="text-white modal-title">{{ $sr_title }}</h3>
                ...
                <div class="p-1">
                    <div class="form-group  searchbox not-empty">
                        <input type="text" wire:model.debounce.500ms="sr_search_query" class="form-control"
                               placeholder="Search...">
                        <i class="input-icon">
                ...
                @if(!empty($sr_data))
                    <ul class="listview image-listview inset">
                        @foreach($sr_data as $rc)
                            <li>
                                <a href="#" class="item" data-bs-dismiss="modal"
                                   wire:click.prevent="srSelection('{{ json_encode($rc) }}')">
