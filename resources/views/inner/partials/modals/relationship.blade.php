...
<div class="modal fade modalbox" wire:ignore.self id="relationships-modal" tabindex="-1" role="dialog">
        ...
        <div class="modal-content pt-0  bg-capsule">
            ...
            <div class="modal-body p-0 bg-capsule">
                <div class="bg-dark-blue  justify-content-between d-flex  align-items-center p-2">
                    <h3 class="text-white modal-title">{{ $rl_title }}</h3>
                ...
                <div class="p-1">
                    <div class="form-group  searchbox not-empty">
                        <input type="text" wire:model.debounce.500ms="rl_search_query" class="form-control"
                               placeholder="Search...">
                        <i class="input-icon">
                ...
                @if(!empty($rl_data))
                    <ul class="listview image-listview inset">
                        @foreach($rl_data as $rc)
                            <li>
                                <a href="#" class="item"  data-bs-dismiss="modal" wire:click.prevent="rlSelection('{{ json_encode($rc) }}')">
