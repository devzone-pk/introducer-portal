<div>
    <div class="appHeader  bg-secondary">
        <div class="left">
            <a href="{{ url('mobile/dashboard') }}" class="headerButton">
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13 14.5L10.5 12L13 9.5" stroke="#FF885B" stroke-width="1.5" stroke-linecap="round"
                    ...
                    <path
                        ...
                        stroke="#FF885B" stroke-width="1.5" />
                    <path
                        ...
                        stroke="#0F5ABB" stroke-width="1.5" stroke-linecap="round" />
                </svg>
            </a>
        </div>
        <div class="pageTitle">
        ...
        <div class="right">
            <a href="#"data-bs-toggle="modal" data-bs-target="#optionwindow"
                class="headerButton  toggle-searchbox">
                <div style="font-family: 'Inter', sans-serif;background-color: #002f6c; color: #fff;  text-align: center; font-size: 14px; font-weight: bold; border-radius: 5px; " class="py-1 px-2" >
                    Menu
                </div>
                {{-- <svg width="30" height="30" viewBox="0 0 24 24" fill="none"
                    ...
                    <path
                        ...
                        stroke="#FF885B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    <path
                        ...
                        stroke="#0F5ABB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    <path
                ...
                <ul class="nav nav-tabs capsuled" role="tablist">
                    <li class="nav-item">
                        <a wire:click.prevent="goTo('transfer')"
                            ...
                            <p
                                class="mb-1 d-flex justify-content-between align-items-center fw-normal align-middle fs-10px">
                                <span>STEP 01</span>
                    ...
                    <li class="nav-item">
                        <a wire:click.prevent="goTo('confirm')"
                            class="nav-link  {{ $selected_window == 'confirm' ? 'active' : '' }}" data-bs-toggle="tab"
                    ...
                    <form wire:submit.prevent="validateSendingDetails">
                        ...
                        @if (!empty($receiving_method))
                            <div class="form-group boxed">
                                <div class="input-wrapper">
                                    ...
                                    <div style="padding-right: 16px; {{ !empty($selected_payer['name']) ? 'height: 58px;' : '' }}"
                                        ...
                                        role="button" wire:click.prevent="payerOpenModel('selected_payer','0')">
                                        <div class="d-flex flex-column ">
                                            ...
                                            @if (!empty($selected_payer['name']) && $success_page == 'mobile')
                                                <strong class="fs-20px bold-600"
                                                    style="color: #000;">{{ !empty($selected_payer['rate_after_spread']) ? number_format($selected_payer['rate_after_spread'], 2) : '' }}
                                                    {{ $selected_payer['currency'] }}</strong>
                                            @endif
                                        </div>
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        @if (strtolower($this->receiving_method) == 'cash' && !empty($selected_payer))
                            <div class="form-group boxed" wire:key="select-field-model-version-{{ $iteration }}">
                                <div class="input-wrapper">
                                    <div class="d-flex text-truncate mobile-input form-control align-items-center  pe-2 justify-content-between @error('selected_cash_destination') is-invalid @enderror"
                                        role="button"
                        ...
                        @if (
                            (!empty($selected_payer) && !empty($selected_cash_destination['id'])) ||
                                (!empty($selected_payer) && strtolower($this->receiving_method) != 'cash'))
                            <div class="row">
                                ...
                                <div class="col-12 mb-1">
                                    <div class="mobile-amounts bg-white mt-1">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div
                                                class="d-flex px-3 bg-gray-c justify-content-between align-items-center">
                                ...
                                <div class="col-12 pt-2 {{ !empty($amounts['coupon_code']) ? 'd-none' : '' }}"
                                    id="have-coupon">
                                    <a onclick="hideMe()" href="javascript:void(0)"
                                        style="color: #002f6c !important">Have a Coupon?</a>
                                </div>

                                <div class="col-12 {{ empty($amounts['coupon_code']) ? 'd-none' : '' }}"
                                    id="have-coupon-input">

                                    <div class="mobile-amounts bg-white mt-2">
                                        <div class="d-flex justify-content-between">
                                            <div class="d-flex flex-column py-2 px-3 ">

                                                <label class="label text-gray fs-16px">Coupon Code</label>
                                                <input oninput="this.value = this.value.toUpperCase()"
                                                    style="font-size: 24px !important;" onclick="this.select()"
                                                    type="text" wire:model.debounce.2000ms="amounts.coupon_code"
                                                    class="form-control sending-amount form-control-lg"
                                                    id="have-coupon" value="" placeholder=""
                                                    autocomplete="off" autocorrect="off" autocapitalize="off">
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        @else
                                                            <p class="fs-16px mb-0">
                                                                {{ $selected_payer['source_currency'] ?? '' }}
                                                                {{ number_format($amounts['fees'], 2) }}</p>
                                                            <p class="fs-16px m-0 text-muted">Total Fees</p>
                                                        @endif
                                                    </div>
                                                </div>
                    ...
                    <form wire:submit.prevent="validateBeneficiaryDetail">
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <div class="d-flex pe-2 mobile-input justify-content-between form-control align-items-center "
                                    role="button" wire:click.prevent="beneOpenModel('selected_beneficiary','1')">
                        ...
                        @if ($show_beneficiary)
                            ...
                            <div class="form-group boxed">
                                <div class="input-wrapper">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-8">
                                            <input type="tel" wire:model.defer="selected_beneficiary.phone"
                            ...
                            <div class="form-group boxed">
                                <div class="input-wrapper">
                                    ...
                                    <div class="d-flex form-control pe-2 justify-content-between mobile-input align-items-center @error('selected_beneficiary.relationship_id') is-invalid @enderror"
                                        role="button" wire:click.prevent="rlOpenModel('selected_beneficiary','1')">
                            ...
                            <div class="form-group boxed">
                                <div class="input-wrapper">
                                    ...
                                    <div class="d-flex form-control mobile-input pe-2 justify-content-between align-items-center @error('selected_sending_reason.id') is-invalid @enderror"
                                        role="button"
                    ...
                    <form wire:submit.prevent="validateBeneficiaryBankDetail">
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <div class="d-flex pe-2 mobile-input justify-content-between form-control align-items-center "
                                    role="button" wire:click.prevent="bbOpenModel('selected_bank_beneficiary','1')">
                        ...
                        @if ($show_beneficiary_bank)
                            <div class="form-group boxed">
                                <div class="input-wrapper">
                                    ...
                                    <div class="d-flex mobile-input justify-content-between pe-2 form-control align-items-center @error('selected_bank_beneficiary.bank_id') is-invalid @enderror"
                                        role="button"
                            ...
                            @if ($receiving_country['iso2'] == 'BD')
                                ...
                                <div class="form-group boxed">
                                    <div class="input-wrapper">
                                        ...
                                        <div class="d-flex mobile-input justify-content-between pe-2 form-control align-items-center @error('selected_bank_beneficiary.branch_name') is-invalid @enderror"
                                            role="button" data-bs-toggle="modal" data-bs-target="#sm_branches">
                                            <span
                    ...
                    <div class=" mt-3">
                        <div class="rounded bg-white shadow-c form-padding mb-4">
                            <table class="table table-bordered   table-sm">
                                ...
                                <tr>
                                    <td>Name</td>
                                    <th>{{ $selected_beneficiary['first_name'] }}
                                        {{ $selected_beneficiary['last_name'] }}</th>
                                </tr>
                                <tr>
                                    <td>Relationship</td>
                                ...
                                <tr>
                                    <td>Phone</td>
                                    <th>{{ $selected_beneficiary['code'] ?? '' }}
                                        {{ $selected_beneficiary['phone'] ?? '' }}</th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    @else
                                        <th>
                                            {{ number_format($amounts['fees'] ?? 0, 2) }}
                                            {{ $selected_payer['source_currency'] ?? '' }}
                                        </th>
                                    @endif
                                </tr>
