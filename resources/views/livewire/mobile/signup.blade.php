<div id="appCapsule">
    ...
    <div class="section mt-0 text-center">
        <img style="width: 40%; margin-bottom: 30px;" src="{{ asset('assets/img/oriump.jpg') }}" alt="">
    </div>
                    ...
                    <div class="custom-control custom-checkbox mt-2 mb-1">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="customCheckb12">
                                Yes, I'd like to receive the latest information and offers from Orium Pay via email, SMS or other electronic means. I can opt-out at any time.</a>
                            </label>
                        </div>
