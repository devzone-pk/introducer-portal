                                            ...
                                            <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;"
                                                ...
                                                <p class=""
                                                   ...
                                                   align="left">
                                                    ...
                                                    Transfer Code: {{ $transfer['transfer_code'] }}<br>
                                                    Sending
                                                    Amount: {{ $transfer['sending_currency'] }} {{ number_format($transfer['sending_amount'],2) }}
                                                    <br>
                                                    Rate 1 {{ $transfer['sending_currency'] }}
                                                    : {{ $transfer['receiving_currency'] }} {{ number_format($transfer['customer_rate'],2) }}
                                                    <br>
                                                    Fee:
                                                    {{ $transfer['sending_currency'] }} {{ number_format($transfer['company_charges'],2) }}
                                                    <br>
                                                    Total Paid:
                                                    {{ $transfer['sending_currency'] }} {{ number_format(($transfer['sending_amount'] + $transfer['company_charges']),2) }}
                                                    <br>
                                                    Recipient gets:
                                                    {{ $transfer['receiving_currency'] }} {{ number_format($transfer['receiving_amount'],2) }}
