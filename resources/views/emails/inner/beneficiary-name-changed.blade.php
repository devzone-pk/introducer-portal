                                ...
                                <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                    ...
                                    <table class="ax-center" role="presentation" align="center" border="0"
                                        ...
                                        <tr>
                                            <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                                <img
                                                        src="https://s3.us-east-1.amazonaws.com/images.devzone.services/documents/AMTZX1lxkuwsTJGbQ1vVq4YVaOOHRXpuZAkyzgm6.png"
                                    ...
                                    <table class="card p-6 p-lg-10 space-y-4" role="presentation" border="0"
                                        ...
                                        <tr>
                                            <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;"
                                                ...
                                                <p class=""
                                                   style="line-height: 24px; font-size: 14px; width: 100%; margin: 0;"
                                                   align="left">
                                                    <strong>Dear  {{ $sender }}</strong><br>
                                                    You changed your receiver details.
                                                </p>

                                                @if($old['first_name'] != $new['first_name'] || $old['last_name'] != $new['last_name'])
                                                    <p style="line-height: 24px; font-size: 14px; width: 100%; margin: 0;"
                                                       align="left">
                                                        Receiver Name
                                                        from {{ $old['first_name'] }} {{ $old['last_name'] }}
                                                ...
                                                @if($old['phone'] != $new['phone'] )
                                                    <p  style="line-height: 24px; font-size: 14px; width: 100%; margin: 0;"
                                                        align="left">
                                                        Receiver phone from {{ $old['phone'] }}
                                                        to {{ $new['phone'] }}
                                                    </p>
                                                @endif

                                                @if($old['relationship_id'] != $new['relationship_id'] )
                                                    <p  style="line-height: 24px; font-size: 14px; width: 100%; margin: 0;"
                                                        align="left">
                                                        Receiver relation from {{ optional(\App\Models\Options\Option::find($old['relationship_id']))->name }}
                                                        to {{ optional(\App\Models\Options\Option::find($new['relationship_id']))->name }}
                                                    </p>
                                                @endif
                                    ...
                                    <p class=" text-center"
                                       style="line-height: 17px; font-size: 11px; width: 100%; margin: 0; color: #0A2545;"
                                       align="center">
                                        <u><strong>United Kingdom:</strong></u><br>
                                        +44 (203) 886-0453 | +44 (203) 886-0454<br>
                                        19 Matcham House, 21 Glenthorne Road, London, W6 0DQ.
                                    </p>

                                    <table class="s-6 w-full" role="presentation" border="0" cellpadding="0"
                                           cellspacing="0" style="width: 100%;" width="100%">
                                        <tbody>
                                        <tr>
                                    ...
                                    <p class=" text-center"
                                       ...
                                       align="center">
                                        <u><strong>United Kingdom:</strong></u><br>
                                        +44 (245) 953337 +44 (245) 953338<br>
