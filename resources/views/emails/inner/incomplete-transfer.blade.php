                                            ...
                                            <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;"
                                                ...
                                                <p class=""
                                                   ...
                                                   align="left">
                                                    ...
                                                    Your
                                                    transfer # {{ $transfer['transfer_code'] }} is not&nbsp;completed
                                                    yet.<br>
                                                    Please complete your transfer so that it's
                                                    processed.

                                                </p>
                                                <br>
                                                <p style="line-height: 24px;  color:#8b0000; font-size: 14px; width: 100%; margin: 0;"
                                                   align="left">
                                                    Please note that incomplete transaction expire within 24 hours.
                                                </p>
