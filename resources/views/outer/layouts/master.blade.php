...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/custom.css') }}?id=1"/>
    @livewireStyles
...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <!-- Button -->
            <a class="navbar-btn btn btn-sm btn-primary  "
               href="{{ url('sign-up') }}">
                Register
            </a>
        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-12 col-md-8">
                <p class="text-start fs-10">
                    We use cookies to improve your experience on our site and to show you relevant information. To find
                    out more, read our Updated
                    <a class="text-secondary fw-bold text-decoration-underline" href="{{ url('privacy-policy') }}">Privacy
...
<script>
    ...
    window.addEventListener('refresh-select2', event => {
        ...
        $('.select-dropdown-rate').select2({
            ...
            templateResult: function (value) {
                if (value.element) {
                    return $("<div class='d-flex flex-column'><div>" + value.text + "</div>  <div style='font-weight: bold;'>" + $(value.element).attr("data-rate") + "</div></div>");
                }
                return 'Choose';
            },
    ...
    $(document).ready(function () {
        ...
        $('.select-dropdown').select2({
            ...
            templateResult: function (value) {
                if (value.element) {
                    return $("<div class='d-flex   align-items-center align-self-center'><img class='rounded-1' style='width:50px;' src='{{ url('assets/flags') }}/" + $(value.element).attr("data-iso2") + ".svg'/>  <div style='font-size:20px;' class='ps-2'>" + value.text + "</div></div>");
                }
                return 'Choose';
            },
            templateSelection: function (value) {
                if (value.element) {
                    return $("<div class='d-flex  align-items-center align-self-center'><img class='rounded-1' style='width:50px;' src='{{ url('assets/flags') }}/" + $(value.element).attr("data-iso2") + ".svg'/>  <div style='font-size:20px;font-weight:600;' class='ps-2'>" + value.text + "</div></div>");
                }
                return 'Choose';
            }
        });
